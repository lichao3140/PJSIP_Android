...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void setCustomGuideView(View customGuideView, View customGuideView2) {
        this.customGuideView = customGuideView;
        this.customGuideView2 = customGuideView2;
        if (!first) {
            restoreState();
        }
    }
    ...
    public void show() {
        ...
        this.setBackgroundResource(R.color.alpha);
    ...
    private void createGuideView() {
        ...
        if (customGuideView2 != null) {
	        LayoutParams guideViewParams2;
	        guideViewParams2 = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	        guideViewParams2.addRule(RelativeLayout.ALIGN_BOTTOM, 123);
	        this.addView(customGuideView2, guideViewParams2);
        }
    }
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                case CIRCULAR://圆形
//                    temp.drawCircle(center[0] + 15, center[1] - 5, radius + 30, mCirclePaint);//绘制圆形
   ...
   public enum Direction {
    ...
    public static class Builder {
        ...
        public Builder setCustomGuideView(View view,View view2) {
            guiderView.setCustomGuideView(view, view2);
            return instance;
        }
